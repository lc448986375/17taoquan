...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20171024"
...
class RestApi(object):
    ...
    def getResponse(self, authrize=None, timeout=30):
        ...
        # 获取response结果
        #=======================================================================
        connection = httplib.HTTPConnection(self.__domain, self.__port, True)
        sys_parameters = {
            P_FORMAT: 'json',
        ...
        connection.request(self.__httpmethod, url, body, header)
